...
// Data Dummy Transaksi Voting (Semuanya berstatus Lunas sesuai arahan)
const initialTransactions: VoteTransaction[] = [
  { id: "TX-90021", date: "21 Juni 2026 16:15", namaKlub: "Paskagama Sakti", voterEmail: "budi.sutrisno@gmail.com", votesCount: 50, amount: 100000, status: "Lunas" },
  { id: "TX-90022", date: "21 Juni 2026 15:40", namaKlub: "Pasgawira", voterEmail: "ani.lestari@yahoo.com", votesCount: 150, amount: 300000, status: "Lunas" },
  { id: "TX-90023", date: "21 Juni 2026 14:10", namaKlub: "Satria Bahari", voterEmail: "candra.eka@gmail.com", votesCount: 10, amount: 20000, status: "Lunas" },
  { id: "TX-90024", date: "20 Juni 2026 19:25", namaKlub: "Bhayangkara Club", voterEmail: "dani.m@gmail.com", votesCount: 200, amount: 400000, status: "Lunas" },
  { id: "TX-90025", date: "20 Juni 2026 11:05", namaKlub: "Ganesha Jaya", voterEmail: "elisa.w@hotmail.com", votesCount: 30, amount: 60000, status: "Lunas" },
  { id: "TX-90026", date: "19 Juni 2026 09:30", namaKlub: "Paskagama Sakti", voterEmail: "fahri.h@gmail.com", votesCount: 120, amount: 240000, status: "Lunas" },
  { id: "TX-90027", date: "18 Juni 2026 21:45", namaKlub: "Pasgawira", voterEmail: "gina.amelia@gmail.com", votesCount: 80, amount: 160000, status: "Lunas" },
  { id: "TX-90028", date: "18 Juni 2026 14:20", namaKlub: "Satria Bahari", voterEmail: "hendra.j@yahoo.com", votesCount: 60, amount: 120000, status: "Lunas" },
  { id: "TX-90029", date: "17 Juni 2026 17:55", namaKlub: "Bhayangkara Club", voterEmail: "irma.s@gmail.com", votesCount: 25, amount: 50000, status: "Lunas" },
  { id: "TX-90030", date: "16 Juni 2026 10:15", namaKlub: "Ganesha Jaya", voterEmail: "joko.w@gmail.com", votesCount: 100, amount: 200000, status: "Lunas" },
];
...
export default function FinanceIndex() {
  ...
  const memberReport = anggotaList.map((anggota) => {
    const clubVotes = filteredTransactions
      .filter((tx) => tx.namaKlub.toLowerCase() === anggota.namaKlub.toLowerCase())
      .reduce((sum, tx) => sum + tx.votesCount, 0);

    return {
      name: anggota.namaKlub,
      school: anggota.sekolah,
      votes: clubVotes,
      amount: clubVotes * 2000,
      status: anggota.statusKta,
    };
  });
    ...
    >
      ...
      <div className="flex flex-wrap gap-2.5 pb-2 border-b border-slate-100">
        {[
          ...
          { key: "Detail Laporan", label: "Detail Laporan Anggota" },
      ...
      {activeTab === "Detail Laporan" && (
        <div className="bg-white rounded-3xl border border-slate-100 p-6 space-y-6 animate-fadeIn">
          <div>
            <h3 className="text-lg font-bold text-slate-800">Detail Laporan Hasil Voting Anggota</h3>
            ...
            <table className="w-full border-collapse text-left text-xs">
              <thead>
                <tr className="bg-slate-50/70 border-b border-slate-100 text-slate-400 font-bold uppercase tracking-wider">
                  ...
                  <th className="p-4">Afiliasi Sekolah</th>
                ...
                {sortedReport.length > 0 ? (
                  sortedReport.map((club, idx) => (
                    <tr key={club.name} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="p-4 font-semibold text-slate-550">{club.school}</td>
                      <td className="p-4 text-center">
                      ...
                      <td className="p-4 text-right font-extrabold text-slate-850">{formatCurrency(club.amount)}</td>
                      <td className="p-4 text-center">
                  ...
                  <tr>
                    <td colSpan={6} className="p-8 text-center text-slate-400 font-semibold text-sm">Tidak ada data anggota.</td>
                  </tr>
                )}
              </tbody>
            </table>
                ...
                {filteredTransactions.length > 0 ? (
                  filteredTransactions.map((tx) => (
                    <tr key={tx.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="p-4 font-bold text-slate-850">{tx.namaKlub}</td>
                      <td className="p-4 font-semibold text-slate-500">{tx.voterEmail}</td>
                      <td className="p-4 text-center font-bold text-slate-700">{tx.votesCount} Suara</td>
